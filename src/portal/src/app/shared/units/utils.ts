...
export enum PageSizeMapKeys {
    ...
    MODEL_SYNC_POLICY_LIST_COMPONENT = 'ModelSyncPolicyListComponent',
    MODEL_SYNC_POLICY_LIST_COMPONENT_EXECUTIONS = 'ModelSyncPolicyListComponentExecutions',
    MODEL_SYNC_TASKS_COMPONENT = 'ModelSyncExecutionTasksComponent',
